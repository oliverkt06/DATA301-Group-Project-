...
Median = 0
Q3 = 4.974 × 10^-14
The real meaning of these three number is 0% points. Thus, the boxplot of Urban: Q1 $\approx$ Median $\approx$ Q3 $\approx$ 0, it shows the box was naturally compressed into a line near y=0.
...
```
To talk about...
median much lower then means = skewed data. Urban vastly outnumber rural. Values increase across all four rows
